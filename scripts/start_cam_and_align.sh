...
#gnome-terminal -e "rosrun tf static_transform_publisher 0.5 -1.0 -1.6 -1.0 -0.1 0.0 3.0 cam_2_depth_optical_frame 3 world"
gnome-terminal -e "rosrun tf static_transform_publisher 0.55 1.1 1.5 0 0.1 2.44 world cam_2_depth_optical_frame 3" # alignment for panda moveit 
